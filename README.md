...
**Works only with Umbrel on Intel processors.**
...
## Features
- **CPU Temperature Monitoring:** View the preferred CPU/package temperature and any additional valid thermal zones exposed by the host.
...
- **Temperature:** Reads valid values from `/sys/class/thermal/thermal_zone*/temp`, filters impossible sensor readings, and prefers CPU package/core sensors for the main temperature display.
